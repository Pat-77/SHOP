...
class Post{
    ...
    public function deleteProduct($data) {
        ...
        try {
            ...
            // Delete dependent rows in the checkedout table
            $sqlCheckedout = "DELETE FROM checkedout WHERE productid = :productId";
            $stmtCheckedout = $this->pdo->prepare($sqlCheckedout);
            $stmtCheckedout->execute([':productId' => $productId]);
    
            // Now delete the product
            $sqlProduct = "DELETE FROM products WHERE productid = :productId";
            ...
            return ['status' => 'failure', 'message' => 'An error occurred: ' . $e->getMessage()];
        }
    }
